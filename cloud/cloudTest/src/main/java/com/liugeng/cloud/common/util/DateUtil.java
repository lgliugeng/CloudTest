...
//	}
    ...
    public static void main(String[] args) throws ParseException {
        //System.out.println(getDaySub(new Date(), new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2018-12-29 15:34:22")));
        Date date = parse("2019-04-19 10:04:38","yyyy-MM-dd HH:mm:ss");
        System.out.println(DateUtils.addHours(date,72).getTime());
        System.out.println(new Date().getTime());
        long l = (DateUtils.addHours(date,72).getTime()-new Date().getTime());
    }
